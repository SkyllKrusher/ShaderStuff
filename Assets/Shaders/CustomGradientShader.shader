Shader "Unlit/CustomGradientShader"
{
    Properties
    {
        _ColorA( "Color A", Color) = (1, 1, 1, 1)
        _ColorB( "Color B", Color) = (1, 1, 1, 1)
        _GradientCentre( "Gradient Centre", Range(0, 1)) = 0.5
        _GradientThick( "Gradient Thickness", Range(0.1, 0.9)) = 0.1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                float t = smoothstep(_GradientCentre - _GradientThick, _GradientCentre + _GradientThick, i.uv.y);
                ...
                float3 finalSurfaceColor = diffuseLight * blend.rgb + directSpecularLight;
